...
void Minesweeper::setDifficulty(GameData::DifficultyLevels newLevel)
{
    switch (newLevel)
    {
...
void Minesweeper::buildGameGrid()
{
    gameGrid.setGrid(GameData::symbol[GameData::Symbols::covered_field]);
}

void Minesweeper::placeMines(int minesCount, const GameData::Location& slot) //Places a mine at a random position minesCount times
{
    clearGameData();
...
void Minesweeper::clearGameData()
{
...
GameData::Location Minesweeper::selectCoordinates()
{
...
void Minesweeper::choseSlotOption(const GameData::Location& slot)
{
...
void Minesweeper::action_click(const GameData::Location& slot)
{
...
void Minesweeper::action_flag(const GameData::Location& slot)
{
...
GameData::Coordinates Minesweeper::getNeighbours(int row, int column)
{
...
void Minesweeper::setMinesNearby(int row, int column, int minesNearby)
{
...
void Minesweeper::gameFinished(const bool won)
{
    system("CLS");
    if (won)
    {
